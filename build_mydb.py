...
parser.add_argument('--db', default='mydatabase.db', help='sqlite3 database')
parser.add_argument('--schema', default='myschema.sql', help='schema definition')
parser.add_argument('--data', default='mydata.sql', help='data')
